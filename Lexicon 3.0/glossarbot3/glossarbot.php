...
<script type="text/javascript">
	...
	alert(document.getElementById('glossarswitch').class);
	document.getElementById('glossarbox').innerHTML=
	'<b><u>'+orgTerm+'</u></b><br />'+description;}
...
LINK_DEFAULT;
	...
	function addSwitcher ($text) {
		...
		$defaults = array('mambots/content/glossarbot/icon_off.gif','mambots/content/glossarbot/icon_on.gif','Turn off inline glossary','Turn on inline glossary','Glossary:');
...
{$parm['switchname']}
  ...
  <a href="javascript:void(0)" id="glossarswitch" onClick="gloss_toggleImage('tog1');gloss_toggleImage('tog2');gloss_swapClass(1,'none','mosinfopop','mosinfopop-off','a'); return false;">
  <img src="{$parm['offlink']}" alt="{$parm['offalt']}" border="0" id="tog1"/></a> <a href="javascript:void(0)" onClick="gloss_toggleImage('tog1');gloss_toggleImage('tog2');gloss_swapClass(1,'none','mosinfopop','mosinfopop-off','a'); return false;"> <img src="{$parm['onlink']}" alt="{$parm['onalt']}" border="0" id="tog2" style="display:none;"/></a>&nbsp;
