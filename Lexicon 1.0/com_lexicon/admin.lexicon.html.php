...
echo '
  ...
  for ($i=1;$i<=$gl_multieditors;$i++)  $editor->save( 'm$i[tdefinition]' ); 
echo '
      if (pressbutton == \'cancel\') {
        submitform( pressbutton );
        return;
...
/*<textarea name="m'.$i.'[tdefinition]" id="m'.$i.'[tdefinition]" cols="70" rows="30" style="width: 500px; height: 150px;"></textarea>
<br /><script type="text/javascript">
<!-- 
	doclink.addButton(\'m'.$i.'[tdefinition]\');
//-->
</script> */
echo $editor->display( 'm'.$i.'[tdefinition]',  $row->tdefinition, '500', '200', '70', '30' );
//editorArea( 'editor$i',  $row->tdefinition, 'm'.$i.'[tdefinition]', '500', '150', '70', '30' ); 
echo '</td>
     </tr>
