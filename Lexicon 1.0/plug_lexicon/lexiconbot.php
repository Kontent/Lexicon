...
// php5
	...
	function linkParams () {
		...
		if ($this->botparams->get('show_image', 1)) $this->parm['image'] = '<img src="' . $this->live_site . '/mambots/content/lexiconbot/info.png" border="0" align="top" alt="lexicon term" />';
		else $this->parm['image'] = '';
		if ($this->botparams->get('show_image', 1)) $bgimage = <<<BG_IMAGE
 background: url("$this->live_site/plugins/content/lexiconbot/info.png") top left no-repeat;
 padding-left: 16px;
BG_IMAGE;
		else $bgimage = '';
